...
export const Navigation = () => {
  return (
    <nav className="bg-[#ea384c] text-white py-4 px-6 sticky top-0 z-50 shadow-md">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 flex-wrap justify-center">
          <PreOrderButton variant="ghost" className="text-white hover:text-white/90 hover:bg-white/10" />
          <RequestChapterForm />
          <a
